...
#     SegNets = DualResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, planes=32, spp_planes=128, head_planes=64, augment=True)
#     if pretrained:
...
#         # SegNets.load_state_dict(model_dict)
        
#         SegNets.load_state_dict(checkpoint, strict = False)
#     return SegNets

# def get_seg_model(cfg, **kwargs):

#     SegNets = DDRNet(pretrained=False)
#     return SegNets
...
#     SegNets = DualResNet(BasicBlock, [3, 4, 6, 3], num_classes=num_classes, planes=64, spp_planes=128, head_planes=256, augment=False)
#     if pretrained:
...
def DDRNet(pretrained=False, num_classes=3):
