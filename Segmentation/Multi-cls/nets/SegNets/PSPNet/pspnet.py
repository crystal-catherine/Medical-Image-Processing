...
from nets.SegNets.PSPNet import resnet as models
from nets.SegNets.sync_batchnorm.batchnorm import SynchronizedBatchNorm2d
...
class PSPNet(nn.Module):
    def __init__(self, layers=50, bins=(1, 2, 3, 6), dropout=0.1, num_classes=2, zoom_factor=8, use_ppm=True,
...
if __name__ == '__main__':
    ...
    model = PSPNet(layers=50, bins=(1, 2, 3, 6), dropout=0.1, num_classes=21, zoom_factor=1, use_ppm=True,
