...
def resnet18(pretrained=False, **kwargs):
    """Constructs a ResNet-18 SegNets.

    Args:
        pretrained (bool): If True, returns a SegNets pre-trained on ImageNet
    """
...
def resnet34(pretrained=False, **kwargs):
    """Constructs a ResNet-34 SegNets.
...
def resnet50(pretrained=False, **kwargs):
    """Constructs a ResNet-50 SegNets.
    ...
    if pretrained:
        ...
        # SegNets.load_state_dict(torch.load(model_path), strict=False)
    return model


def resnet101(pretrained=False, **kwargs):
    """Constructs a ResNet-101 SegNets.
...
def resnet152(pretrained=False, **kwargs):
    """Constructs a ResNet-152 SegNets.
