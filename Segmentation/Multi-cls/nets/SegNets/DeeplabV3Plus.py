...
class ResNet(nn.Module):
    def __init__(self, block, layers, os=16):
        ...
        # Modules
        self.conv1 = nn.Conv2d(1, 64, kernel_size=7, stride=2, padding=3, bias=False) # 3-->1
...
#     SegNets = Deeplabv3plus(backbone=resnet50, num_classes=num_classes, os=os, freeze_bn=False)
#     return SegNets
